---
layout: post
title: "The Orioles' Failure to Land an Ace May Have Cost Them the Season"
date: 2026-08-09 09:00:00 -0400
categories: [orioles]
section_theme: orioles
permalink: /orioles/missing-ace/
author: "Randy Morgan"
...
hero_image: /assets/images/orioles-dylan-cease-2026.jpg
hero_wide: true
hero_alt: "Dylan Cease delivers a pitch for the Toronto Blue Jays"
hero_credit: "Photo: MLB.com — Dylan Cease's near no-hitter against San Francisco, July 8, 2026."
hero_credit_url: "https://www.mlb.com/news/dylan-cease-takes-no-hitter-into-ninth-inning-vs-giants"
---
...
<section class="orioles-missing-ace-results" aria-label="Estimated impact of free-agent starter scenarios">
    ...
    <table>
      <thead>
        <tr>
          ...
          <th scope="col">Runs saved</th>
          <th scope="col">Wins added</th>
          <th scope="col">Estimated Orioles record</th>
        </tr>
      </thead>
      <tbody>
        <tr class="orioles-missing-ace-results-baseline">
          <th scope="row">Actual Orioles</th>
          <td>&mdash;</td>
          <td>&mdash;</td>
          <td>56-60</td>
        </tr>
        <tr class="orioles-missing-ace-results-highlight">
          <th scope="row">Dylan Cease</th>
          <td>49.4</td>
          <td><strong>+5.0</strong></td>
          <td><strong>~61-55</strong></td>
        </tr>
        <tr>
          <th scope="row">Ranger Suarez</th>
          <td>34.5</td>
          <td><strong>+3.4</strong></td>
          <td><strong>~59-57</strong></td>
        </tr>
        <tr>
          <th scope="row">Michael King</th>
          <td>22.2</td>
          <td><strong>+2.2</strong></td>
          <td><strong>~58-58</strong></td>
        </tr>
        <tr>
          <th scope="row">Framber Valdez</th>
          <td>23.8</td>
  ...
  <p class="orioles-missing-ace-results-note">The model compares each target with the Orioles' fifth-starter/depth workload, using FIP and Baltimore's actual run environment. It is an estimate, not a replay of the season.</p>
</section>
...
<figure class="orioles-article-figure">
  <img src="{{ '/assets/images/orioles-kyle-bradish-2026.jpg' | relative_url }}" alt="Kyle Bradish delivers a pitch for the Baltimore Orioles at Camden Yards" loading="lazy">
  <figcaption>Photo: <a href="https://www.mlb.com/orioles/news/kyle-bradish-takes-no-hitter-into-7th-in-orioles-win" target="_blank" rel="noopener">MLB.com — Kyle Bradish's July 2026 no-hit bid at Camden Yards.</a></figcaption>
</figure>
