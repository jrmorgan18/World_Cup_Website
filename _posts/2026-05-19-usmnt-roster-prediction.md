...
**Tier 1 · The Locks (14)**
Turner, Freese, Dest, Antonee Robinson, Richards, McKennie, Adams, Reyna, Tillman, Tessmann, Pulisic, Weah, Balogun, Pepi
...
**Tier 2 · The Probables (8)**
Ream, Aaronson, Freeman, Arfsten, Berhalter, Luna, Wright, McKenzie
...
**Tier 3 · The Bubble (4)**
Roldan, Horvath, Miles Robinson, Scally
...
**Tier 4 · Just Missed (4)**
Zendejas, Trusty, McGlynn, Sargent
...
**Tier 5 · The Wildcards (2)**
Noahkai Banks, Zavier Gozo
...
<div class="roster-compare" markdown="0">
  <div class="roster-compare-pos">
    <h3>Goalkeepers (3)</h3>
    <div class="roster-compare-cols">
      <div class="roster-col">
        <div class="roster-col-head">Randy's Picks</div>
        <ul>
          <li>Matt Turner</li>
          <li>Matt Freese</li>
          <li>Ethan Horvath</li>
      ...
      <div class="roster-col">
        <div class="roster-col-head">Pochettino's Picks</div>
        <ul>
          <li>Matt Turner</li>
          <li>Matt Freese</li>
          <li>Ethan Horvath</li>
  ...
  <div class="roster-compare-pos">
    <h3>Defenders <span class="count-note">Randy 8 · Pochettino 9</span></h3>
    <div class="roster-compare-cols">
      <div class="roster-col">
        <div class="roster-col-head">Randy's Picks</div>
        <ul>
          ...
          <li>Mark McKenzie</li>
          <li>Alex Freeman</li>
          <li class="diff">Auston Trusty</li>
        </ul>
      </div>
      <div class="roster-col">
        <div class="roster-col-head">Pochettino's Picks</div>
        <ul>
          ...
          <li>Mark McKenzie</li>
          <li>Alex Freeman</li>
          <li class="diff">Max Arfsten</li>
          <li class="diff">Miles Robinson</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="roster-compare-cols">
      <div class="roster-col">
        ...
        <ul>
          ...
          <li>Sebastian Berhalter</li>
          <li>Diego Luna</li>
          <li class="diff">Jack McGlynn</li>
        </ul>
      </div>
      <div class="roster-col">
        <div class="roster-col-head">Pochettino's Picks</div>
        <ul>
          ...
          <li>Sebastian Berhalter</li>
          <li>Diego Luna</li>
          <li class="diff">Cristian Roldan</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="roster-compare-pos">
    <h3>Forwards <span class="count-note">Randy 6 · Pochettino 5</span></h3>
    <div class="roster-compare-cols">
      <div class="roster-col">
        <div class="roster-col-head">Randy's Picks</div>
        <ul>
          ...
          <li>Tim Weah</li>
          <li>Folarin Balogun</li>
          <li>Ricardo Pepi</li>
          <li>Haji Wright</li>
          <li class="diff">Alejandro Zendejas</li>
        </ul>
      </div>
      <div class="roster-col">
        <div class="roster-col-head">Pochettino's Picks</div>
...
<div class="roster-builder-plug" markdown="0">
  <p><strong>Disagree with my picks?</strong> Build and share your own 26-man USMNT roster with our interactive Roster Builder.</p>
  <a href="https://jrmorgan18.github.io/USMNT_Roster_Site/" target="_blank" rel="noopener">Launch Roster Builder →</a>
</div>
